document.defaultView.addEventListener("load",function(){var i=document.querySelectorAll("[data-vkb-slider]"),i=Array.from(i);var s;if(i)for(var r in i){var l=i[r],t=JSON.parse(l.getAttribute("data-vkb-slider"));void 0===t.zoomFinalScale&&void 0!==t.zoomFinalScal&&(t.zoomFinalScale=t.zoomFinalScal),l.classList.contains("swiper")||l.classList.add("swiper");let e="";void 0!==t.blockId?e=t.blockId:void 0!==t.clientId&&(e=t.clientId),l=t,s=e,l.zoomAnimation&&(l=((e,i)=>{var{zoomAnimation:e,zoomInitialScale:s,zoomFinalScale:r,autoPlayDelay:l,speed:t}=e;let a="";return e&&(e=".vk_slider_"+i,a+=`
